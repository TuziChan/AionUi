...
export const useDragUpload = ({ supportedExts = [], onFilesAdded, onWorkspaceFileDrop, conversationId }: UseDragUploadOptions) => {
  ...
  const handleDrop = useCallback(
    ...
    [conversationId, onFilesAdded, onWorkspaceFileDrop, supportedExts, t]
  );
